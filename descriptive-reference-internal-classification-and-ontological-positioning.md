...
- Integrated Form
- Constellation Group
- Peripheral Manifestations and Figural Registers
...
1. **Interior Atlas Configuration I** — An early spatial articulation establishing internal orientation.
2. **First Emanation Study A** — A minimal outward registration of an internal configuration.
3. **Tranquil Interval I** — A visual articulation shaped primarily by reduction and pause.
4. **Integration Phase Work I** — A more consolidated articulation, contingent on internal coherence.
5. **Selected Constellation I** — A contextual grouping of internally aligned works, if recognised.
6. **Peripheral Manifestations I** — A lateral or non-central articulation emerging at the periphery of the primary internal configuration.
7. **Figural Registers I** — A moment in which internal configurations align to produce a recognisable figural or symbolic form without representational intent.
...
Return to [README](../README.md) · See also: [The Poem Before the Image](the-poem-before-the-image.md) · [Terminology](terminology.md)
