...
File	Description
docs/introduction.md	Home
docs/the-poem-before-the-image.md	The Poem Before the Image
docs/reader-orientation-and-interpretive-boundaries.md	Reader Orientation and Interpretive Boundaries
docs/descriptive-reference-internal-classification-and-ontological-positioning.md	Descriptive Reference, Internal Classification, and Ontological Positioning
docs/completion-suspension-and-release.md	Completion, Suspension, and Release
docs/scope-future-context-and-conditions-of-visibility.md	Scope, Future Context, and Conditions of Visibility
docs/diagrams.md	Visual Companion
DISCLAIMER.md	Disclaimers & Legal Context
docs/terminology.md	Supplementary glossary (not a separate site page)
assets/visual-companion.png	Original Visual Companion composite image
CITATION.cff	Citation metadata for this archive
LICENSE.md	All-rights-reserved licence statement
COPYRIGHT.md	Standalone copyright notice and attribution guidance
Note on Language
