...
![NeusktchmechArc Visual Companion composite diagram](../assets/visual-companion.png)
...
```mermaid
flowchart TD
    IA["Interior Atlas\nA conceptual landscape of experience"]
    T["Layered terrain of memory\nDeferred inclination - structured regions of memory - reservoirs of positive valence"]
    PW["Pocket Watch\nZone of altered temporal reference"]
    LT["Luminous Threshold\nMoment of conceptual realignment"]
...
```mermaid
flowchart TD
    A["Interior Atlas\nA conceptual landscape of experience"] --> B["First Emanation\nInitial outward emergence of an impression"]
    B --> C2["Tranquil Rift\nA deliberate pause for settling"]
    C2 --> D["Integration Phase\nMeaning consolidated into form"]
    D --> E["Completion, Suspension, or Release\nA threshold, not a final state"]
    E -.->|"Unresolved ideas may return"| A
```
...
![NeusktchmechArc Visual Companion — Origin, Continuity, and Horizon](../assets/visual-companion-3b.png)

### 4a. Origin — The Inner Journey Unfolds

```mermaid
flowchart LR
    IA["Interior Atlas\nMapping the inner landscape with awareness"] --> FE["First Emanation\nThe beginning of form, from feeling to emergence"]
    FE --> TR["Tranquil Rift\nA pause within, space for realignment"]
    TR --> IP["Integration Phase\nWeaving experience into form"]
```
...
```mermaid
flowchart LR
    W["Writing\nThe first articulation of inner experience"] --> CE["Community Experience\nShared reflections that deepen understanding"]
    CE --> VE["Visual Exploration\nImages and symbols that reveal the unseen"]
    VE --> IA2["Interior Atlas\nMapping the inner landscape with awareness"]
    IA2 --> FE2["First Emanation\nThe beginning of form, from feeling to emergence"]
    FE2 --> TR2["Tranquil Rift\nA pause within, space for realignment"]
    TR2 --> IP2["Integration Phase\nWeaving experience into form"]
```
